...
action "stripe_forwarding_request" "test" {
  config {
    ...
    request = {
      body = "{\"amount\":{\"currency\":\"USD\",\"value\":1000},\"reference\":\"forwarding_request_action_regression\",\"card\":{\"number\":\"\",\"exp_month\":\"\",\"exp_year\":\"\",\"cvc\":\"\",\"name\":\"\"}}"
      headers = [
        {
          name  = "Authorization"
    ...
    metadata = {
      suite = "sdk-codegen"
      case  = "forwarding_request_action_regression"
    }
  }
}
