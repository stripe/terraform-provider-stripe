...
resource "stripe_v2_core_event_destination" "eventbridge" {
  ...
  description   = "sdk-codegen eventbridge destination updated"
...
resource "stripe_v2_core_event_destination" "webhook" {
  ...
  description   = "sdk-codegen webhook destination updated"
  ...
  webhook_endpoint {
    url = "https://example.com/sdk-codegen/event-destination/{{RAND}}/updated"
  }
