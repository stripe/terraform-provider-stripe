...
page_title: "stripe_coupon Resource - terraform-provider-stripe"
subcategory: ""
description: |-
...
- `type` (String) One of `amount_off`, `percent_off`, or `script`. Describes the type of coupon logic used to calculate the discount.
...
- `display_name` (String) The name of the script used to calculate the discount.
