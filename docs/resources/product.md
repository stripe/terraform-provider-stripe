...
- `marketing_features` (Block List) A list of up to 15 marketing features for this product. These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table) and are display-only; they do not create Stripe Entitlements or product-feature attachments. (see [below for nested schema](#nestedblock--marketing_features))
